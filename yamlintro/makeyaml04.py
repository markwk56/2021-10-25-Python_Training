...
def main():
    ...
    yammyfile = open("/home/student/2021-10-25-Python_Training/yamlintro/myYAML.yml", "r")
    ...
    yammyfile2 = open("/home/student/2021-10-25-Python_Training/yamlintro/myYAML.yml.updated", "w")
